...
\begin{enumerate}
	...
	$$
	Note that the wager is nonnegative, and in effect includes selection systems, as $W_n = 0$ corresponds to not betting at all. We note that $W_n$ is measurable $\fcal_{n-1}$, being a function of $X_1, \cdots, X_{n-1}$. Finally, we note that:
	$$
		F_n = F_{n-1} + W_nX_n
	$$
...
\paragraph{Theorem 7.2: Expected Stopping Time Aware Fortune Value}
