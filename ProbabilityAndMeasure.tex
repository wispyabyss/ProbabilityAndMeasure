...
\paragraph{Proof:} Note, we will later show that under the assumption $p \leq q$, we have:
$$
	Q(x) \geq pQ(x + t) + qQ(x - t) \quad\quad
	0 \leq x - t \leq x \leq x + 1 \leq 1
$$
We will prove why this equation proves optimality. However, we won't prove the equation - as I'm getting quite bored of this section.
