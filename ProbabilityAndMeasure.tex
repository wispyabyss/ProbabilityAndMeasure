...
$$
	\mu(A) = \sum_{j1,\cdots,j_j} \mu(B_{j_1,\cdots,j_k})
$$
...
$$
	\sum_{j1,\cdots,j_j} \mu(B_{j_1,\cdots,j_k}) =
	\sum_{j1,\cdots,j_j} \Delta_{B_{j_1,\cdots,j_k}} F =
	\sum_{j1,\cdots,j_j} \sum_x \sgn_B x \cdot F(x)
$$
...
$$
Across the $k$ dimensions. Assume the $A_u$ are disjoint. For each $1 \leq i \leq k$, the intervals $I_{i1}, \cdots, I_{in}$ must equal $I_i$.
