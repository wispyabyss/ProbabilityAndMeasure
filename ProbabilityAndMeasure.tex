...
\end{enumerate}
Show that a necessary and sufficient condition for $F_n \Leftarrow F$ is that $d(F_n,F) \to 0$ - ie, they are equivalent.
\\\\
...
$$
\textbf{Triangle Inequality} This is the last property we need to prove.
