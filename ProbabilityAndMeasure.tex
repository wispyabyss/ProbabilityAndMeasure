...
\begin{enumerate}
	...
	$$
		\sigma(\fcal_0 \cap A)
	$$
	Then, make use of Theorem 10. We have that $\fcal_0$ generates $\fcal$ in $\Omega$, and so $\fcal_0 \cap A$ generates the restricted $\sigma$ field $\sigma(\fcal_0) \cap A = \fcal \cap A$:
	$$
