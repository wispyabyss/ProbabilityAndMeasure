...
$$
With probability $1$. Intuitively, this will only be the case if $p \geq \frac{1}{2}$. Note, this follows rigorously from our gambling ruin framework as well. This can be be rephrased in terms of winning bets exceeding losing bets.
