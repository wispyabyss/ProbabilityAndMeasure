...
\subsection{Refinement of the Second Borel-Cantelli Lemma}
...
\subsubsection{6.3} As in Example 5.6 and 6.3, let $\omega$ be a random permutation of $1, 2, \cdots, n$. Each $k$, $1 \leq k \leq n$, occupies some position in the bottom row of the permutation $\omega$:
$$
	\begin{pmatrix}
	1 & 2 & \cdots & n\\
	p_1 & p_2 & \cdots & p_n
...
$$
Or something like that. However, the calculation becomes difficult to simplify. We look at the solutions.
