...
$$
And we found $k = f(x)$ is the satisfying point. Also note, this is all done with the \textit{Lebesgue Integral} with respect to the \textit{Lebesgue measure} $\lambda$. We only used properties of $\lambda$ that we already proved. I guess, we do need that $\lambda$ is integrable, maybe?
