...
$$
	...
	a\mu(\Omega) + 1 < \infty
$$
Where we note that $f \1{A^c} = 0$ almost everywhere. And so, with uniform integrability of $f_n$, $\mu(\Omega) < \infty$, $f_n \to f$ almost everywhere, and Fatou's Lemma, we can conclude that $f$ is integrable.
