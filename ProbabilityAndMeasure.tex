...
\\\\
We now want to find an analogue of the equation $\mu(a,b] = F(b) - F(a)$ in higher dimensions. A bounded rectangle has $2^k$ vertices - for each entry in $(x_1, \cdots, x_k)$, we have a choice of $2$ - $a_i$ or $b_i$. 
