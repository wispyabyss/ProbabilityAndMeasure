...
$$
Where the first equality makes use of Theorem 15.1.i. If $f$ is a simple nonnegative function, then equality follows via linearity of the integral. Finally, for $f$ nonnegative, then:
$$
...
$$
Recall, we already discussed this at the enf of section 13. This is a pullback measure, as we pull $A'$ back into $\fcal$ via $T^{-1}$.
\\\\
...
\\\\
Note that $0 \leq f_n - f_1 \uparrow f_n - f_1$. Note, non-negativity comes from the $f_n$ getting larger. Thus, we have via Monotone convergence theorem:
$$
