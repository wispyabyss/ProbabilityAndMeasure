...
$$
Note, by the definition of supremum, such a $\tau_j$ exists for each $v(j)$. Recall that by definition:
$$
...
$$
And by definition, $v$ is thus \textit{excessive}. qed.
