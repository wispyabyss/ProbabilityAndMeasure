...
\\\\
In $\R^k$, there is an analogous $k$ dimensional Lebesgue measure $\lambda_k$ on the class $\rcal^k$ of $k$ dimensional borel sets. Example 11.4 shows us that the class of bounded rectangles is indeed a semiring.
