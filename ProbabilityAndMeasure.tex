...
$$
How many of these intervals $I_i$ have interiors that meet $A_\epsilon$? Note if $I_i$ has an interior that meets $A_\epsilon$, the difference above would be larger than $\epsilon$ (as in the definition of $A_\epsilon$, we could take $\delta$ less than half the length of the interval $I_i$). 
