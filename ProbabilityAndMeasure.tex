...
$$
Actually, prove by induction. First note that:
$$
	|\det T|\lambda_k(A) =
	|\det T_2||\det T_1|\lambda_k(A) =
	|\det T_2|\lambda_k(T_1A)	
$$
...
\\\\
Note. We can extend to all cubes via translation invariance, and rectangles. Then, maybe we can try and extend to all measurable sets - the property of elementary linear transformations. I think this is what we need. Maybe make use of Theorem 11.4.
