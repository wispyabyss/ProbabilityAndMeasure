...
$$
	...
	\right\}
$$
Note that $G = \sigma(A)$. This can be done by showing 1. $A \subset\ G$ (this is clear). 2. $G$ is a $\sigma$ algebra (this should also be clear). 3. $\sigma(A) \subseteq G$ by 1 and 2. 4. $G \subseteq \sigma(A)$ by definition. Thus, every $B \in \sigma(A)$ has a countable subclass $A_B$ of $A$ such that $B \in \sigma(A)$.
