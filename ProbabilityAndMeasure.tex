...
\begin{enumerate}
	...
	\item For each $r$, $\lim_k x_{t,r_{n,k}}$ exists for $t \leq r$
\end{enumerate}
...
\\\\
The next portion of the proof relies on taking arbitrary finite subsets $M \subset S$, and using finiteness to extract out some necessary properties.
