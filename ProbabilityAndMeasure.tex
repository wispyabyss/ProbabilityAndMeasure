...
\paragraph{Example 16.1 - Counting Measure} Suppose that $\Omega$ is countable - $\Omega = \{1, 2, \cdots\}$ to be definite. Let $\fcal$ consist of all subsets of $\Omega$, and $\mu$ is the counting measure - each singleton has measure $1$.
\\\\
A function is thus a sequence. 

\paragraph{Example 16.2 - Principal Value}
