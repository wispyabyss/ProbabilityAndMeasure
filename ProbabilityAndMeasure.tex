...
$$
	\int \liminf_n f_n d\mu \leq \liminf n \int f_n d\mu
$$
\textbf{Proof:} If $g_n = \inf_{k \geq n} f_k$, then $0 \leq g_n \uparrow g = \liminf_n f_n$. Theorem 16.1 gives monotonicity, and Theorem 16.2 monotone convergence theorem gives:
$$
	\int f_n d\mu \geq \int g_n d\mu \uparrow \int g d\mu
$$
As this is true for all $n$, we have:
$$
	\int g d\mu = \int \liminf_n f_n d\mu \leq \liminf n \int f_n d\mu
$$
