...
\subsubsection{3.18 All non-zero outer measure sets contain a non measurable subset} Let $H$ be the nonmeasurable set constructed at the end of the section (the Vitali Set).
\begin{enumerate}
...
\subsubsection{3.19} The aim of this problem is the construction of a Borel set $A$ in $(0,1)$ such that:
$$
