...
\begin{enumerate}
	\item Does the integral exist? Even though $f(x,\cdot)$ is measurable, we still might not get existence, such as in the $\infty - \infty$ case.
...
\\\\
Now, this immediately extends to $f$ nonnegative simple functions, via linearity of the integrals.
