...
\begin{enumerate}
	...
	\\\\
	Note, as $m_x$ is measurable, the integral is well defined. Also, the integral exists, as $m_x$ is nonnegative. As for probability measure, it is clear that $\pi(\emptyset) = 0$. The last part we need is just countable additivity.
