...
\textbf{Proof:} \begin{enumerate}
	...
	$$
	Where $= 0$ comes from the initial hypothesis. By Theorem 15.2(ii), if the measure where the function $\1{A_n \cap B_n} f - g$ was greater than 0, the integral would be greater than 0.
\end{enumerate}
