...
$$
	...
	\pi''(E) = \int_Y \mu\left[x : (x,y) \in E\right] \mu(dy)
$$
If both measures are countable, we would have $\pi'(E) = \pi''(E)$. Note, $E \in \xcal \times \ycal$
