...
\\\\
We now consider finite unions that are not disjoint. In this case, we consider our same $A$. However, we note that in each iteration, we add at least $3n/4$ of the final $3n$ entries. We consider the $A'$, which 
