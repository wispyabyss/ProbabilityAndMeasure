...
\\\\
For $\lcal$ and $\Lambda$ as defined, we were able to show a couple of properties in problems 11.4 and 11.5. We will need to use those properties in the following problem.
