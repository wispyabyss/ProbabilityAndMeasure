...
$$
	T_x(y) = (x,y)
$$
Ie $E = A \times B$ is a measurable rectangle, $T_x^{-1}$ is $B$ or $\emptyset$, as we are taking a cartesian product here, and in either case, $T_x^{-1}E \in \ycal$. By Theorem 13.1(i), as the measurable rectangles generate $\xcal \times \ycal$, we have $T_x$ is measurable $\ycal/\xcal \times \ycal$. Hence:
$$
